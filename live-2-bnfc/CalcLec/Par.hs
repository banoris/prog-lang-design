...
{-# INLINE happyOut6 #-}
newtype HappyWrap7 = HappyWrap7 (CalcLec.Abs.Exp)
happyIn7 :: (CalcLec.Abs.Exp) -> (HappyAbsSyn )
happyIn7 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap7 x)
{-# INLINE happyIn7 #-}
happyOut7 :: (HappyAbsSyn ) -> HappyWrap7
happyOut7 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut7 #-}
newtype HappyWrap8 = HappyWrap8 (CalcLec.Abs.Exp)
happyIn8 :: (CalcLec.Abs.Exp) -> (HappyAbsSyn )
happyIn8 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap8 x)
{-# INLINE happyIn8 #-}
happyOut8 :: (HappyAbsSyn ) -> HappyWrap8
happyOut8 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut8 #-}
newtype HappyWrap9 = HappyWrap9 (CalcLec.Abs.Exp)
happyIn9 :: (CalcLec.Abs.Exp) -> (HappyAbsSyn )
...
happyReduction_4 happy_x_3
	...
	happyIn7
		 (CalcLec.Abs.EAdd happy_var_1 happy_var_3
	)}}
...
happyReduction_5 happy_x_3
	...
	case happyOut8 happy_x_3 of { (HappyWrap8 happy_var_3) -> 
	happyIn7
		 (CalcLec.Abs.ESub happy_var_1 happy_var_3
	)}}
...
happyReduction_7 happy_x_3
	...
	happyIn8
		 (CalcLec.Abs.EMul happy_var_1 happy_var_3
	)}}
...
happyReduction_8 happy_x_3
	...
	case happyOut9 happy_x_3 of { (HappyWrap9 happy_var_3) -> 
	happyIn8
		 (CalcLec.Abs.EDiv happy_var_1 happy_var_3
	)}}
